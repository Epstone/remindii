...
namespace Tests
{
    ...
    public class MainTest
    {
        ...
        public void HourlyMaintenanceTest()
        {
            ...
            {
                int mailID = db.GetEmailID(emailAddress);
                db.AddReminder(reminder, mailID, DateTime.Now.AddDays(-1));
            }
        ...
        public void GetReminderAndUserCountTest()
        {
            using (var db = new Database())
            {
                Console.WriteLine("User Count = " + db.GetUserCount());
                Console.WriteLine("Reminder Count = " + db.GetReminderCount());
            }
        }
    }
}
